...
（辛苦carry个确认，表格内容是否完整，以及即将上架lua开源的规则应该放在哪个维度下？）
...
|**维度**|<img width=80/>**工具**|**工具ID**|**支持语言**|**License 类型**|**CodeCC交付后立即可用**|**工具介绍**|
| :-: | :-: | :-: | :-: | :-: | :-: | :-: |
|**发现代码缺陷**|Coverity|COVERITY|C/C++,JAVA,C#,JS,<br>OC/OC++,Python,PHP,<br>Ruby,Golang,Swift,TS|商业|否|斯坦福大学科学家研究成果，被第三方权威调查机构VDC评为静态源代码分析领域的领导者。|
